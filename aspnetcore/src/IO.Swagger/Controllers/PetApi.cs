...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/englitch/Petstore/1.0.0/pet")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/englitch/Petstore/1.0.0/pet/{petId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/englitch/Petstore/1.0.0/pet/findByStatus")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/englitch/Petstore/1.0.0/pet/findByTags")]
        [ValidateModelState]
